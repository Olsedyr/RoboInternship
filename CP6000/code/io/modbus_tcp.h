...
/***********************************************************************
	...
	trio_read_holding_registers_tcp()
...
#define MAX_READ_REGS 128

int trio_read_holding_registers_tcp( int slave, int start_addr, int count,
    short *dest, int dest_size, int fd );

int read_holding_registers_tcp( int slave, int start_addr, int count,
    short *dest, int dest_size, int fd );
int read_holding_registers_tcp_async1( int slave, int start_addr, int count,
    short *dest, int dest_size, int fd );
int read_holding_registers_tcp_async2( int slave, int start_addr, int count,
    short *dest, int dest_size, int fd );
...
/*************************************************************************
	...
	trio_preset_multiple_registers_tcp()
...
int preset_multiple_registers_tcp_async1( int slave, int start_addr, int reg_count, short *data, int fd );
int preset_multiple_registers_tcp_async2( int slave, int start_addr, int reg_count, short *data, int fd );
