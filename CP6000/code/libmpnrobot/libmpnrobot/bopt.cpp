...
void bane::gradientMetode() {
  ...
  for (int j=0;j<5;j++) { //joints
    ...
    while ((gmax>0.000001)&&(alpha[i]>alphatot)) {
      ...
      p4.x = (p1.x+p3.x)*0.5; //saet midtpunkt mellem brackets -> kendes med en sikkerhed p� deta.
...
//#define TESTB //Test at l�sning er globalt optimal
...
int main () {
  ...
  //b.controlpoints.pos[2].array[0]=3.5; //Tving viapunkt til bestemt v�rdi
